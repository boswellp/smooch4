        ...
        if (!A) {
            ...
            A = document.createElement("iframe"), A.frameBorder = 0, A.allowFullscreen = !0, A.allowTransparency = !0, A.className = d.default.ref().locals.iframe, A.onload = function() {
                if (!t) {
                    ...
                    e.open(), e.write('\n<!DOCTYPE html>\n<html>\n<head>\n<link rel="stylesheet" href="https://raw.githubusercontent.com/boswellp/smooch4/master/smooch_4_0_0_frame.css" type="text/css" />\n<script src="https://raw.githubusercontent.com/boswellp/smooch4/master/smooch_4_0_0_frame.js" async crossorigin="anonymous"><\/script>\n</head>\n<body>\n<div id="mount"></div>\n</body>\n</html>\n'), e.close()
                }
            }
        }
